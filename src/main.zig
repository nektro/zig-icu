...
export fn u_hasBinaryProperty(cp: u32, prop: t.UProperty) bool {
    return switch (prop) {
        ...
        .UCHAR_EMOJI => false, // TODO
        .UCHAR_EMOJI_PRESENTATION => false, // TODO
        .UCHAR_EMOJI_MODIFIER => false, // TODO
        .UCHAR_EMOJI_MODIFIER_BASE => false, // TODO
        .UCHAR_EMOJI_COMPONENT => false, // TODO
        .UCHAR_REGIONAL_INDICATOR => icu.hasProperty(cp, .Regional_Indicator),
        .UCHAR_PREPENDED_CONCATENATION_MARK => false, // TODO
        .UCHAR_EXTENDED_PICTOGRAPHIC => false, // TODO
